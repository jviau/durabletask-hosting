...
{
    /// <summary>
    /// Gets an <see cref="IActivityRequest{TOutput}" /> which has an explicitly provided input.
    /// </summary>
    /// <remarks>
    ...
    public static IActivityRequest<TOutput> Create<TOutput>(TaskActivityDescriptor descriptor, object? input = null)
